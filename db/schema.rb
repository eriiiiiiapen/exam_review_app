...
ActiveRecord::Schema[8.1].define(version: 2026_02_20_131134) do
  ...
  create_table "study_logs", force: :cascade do |t|
    ...
    t.integer "understanding_level", default: 0, null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["topic_id"], name: "index_study_logs_on_topic_id"
    t.index ["user_id", "topic_id"], name: "index_study_logs_on_user_id_and_topic_id"
